...
Optionally, you can include a `homepage` key (the project's official website, e.g. `https://example.com`) at the top level of the config file; if present, it will be displayed as a link on the app card.
